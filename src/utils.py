...
class MLPCWrapper(BaseEstimator):
    ...
    with skopt's Categorical produces the following error message:
    ---
    ...
    def __init__(self,
        ...
        ----------
        model: MLPClassifier
            A fitted instance of MLPClassifier (initialized as None)
        """
        # parameters
    ...
    def __repr__(self) -> str:
        ...
        n, a, s = self.num_layers, self.activation, self.solver
        l, li, m = self.learning_rate, self.learning_rate_init, self.max_iter
        return f"{c}({n!r}, {a!r}, {s!r}, {l!r}, {li!r}, {m!r})"
