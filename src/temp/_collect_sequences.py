...
def get_dna_modification(num_ids: int) -> None:
    """
    ...
    get_sequences(db=BASE_DIR+"dna_modification", terms=terms, num_ids=num_ids)
    
def get_dna_replication(num_ids: int) -> None:
    """
    ...
    get_sequences(db=BASE_DIR+"dna_replication", terms=terms, num_ids=num_ids)
...
def get_lysogeny_repressor(num_ids: int) -> None:
    """
    ...
    get_sequences(db=BASE_DIR+"lysogeny_repressor", terms=terms, num_ids=num_ids)
...
def get_other(num_ids: int) -> None:
    """
    ...
    get_sequences(db=BASE_DIR+"other", terms=terms, num_ids=num_ids)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-num_ids", default="100000")
    ...
    # check whether <func_class> was provided to sys.argv
    if class_ is None:
